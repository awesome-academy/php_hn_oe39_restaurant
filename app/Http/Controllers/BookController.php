...
class BookController extends Controller
{
    ...
    {
        $book = $this->bookRepo->getBookWithCategoryAndImageById($id);
    ...
    public function update(UpdateBookRequest $request, $id)
    {
        ...
        if (isset($request->image)) {
            ...
            $image = $this->bookRepo->getBookWithImageById($id)->image;
    ...
    {
        $book = $this->bookRepo->getBookWithCategoryAndImageAndLikesById($id);
        $reviews = $this->reviewRepo->getReviewsWithUsersAndCommentsAndLikesByBookId($id);
